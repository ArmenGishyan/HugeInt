...
namespace ArithmeticAtility
{
	...
	std::vector<bool> multiplyTwoNumber(const std::vector<bool>& number_1, const std::vector<bool>& number_2);
	...
	std::vector<bool> numberAsBool(char ch);
	void reverseNumber(std::vector<bool>& number);
}